# -*- coding: utf-8 -*-
"""
Created on Sun Dec  9 04:21:36 2018
...
#df_trains,stest = train_test_split(train,test_size=0.40,random_state=42)
df_test = pd.read_csv('testModel.tsv', sep='\t')
#df_test=df_test.drop(df_test.price)
#df_test,smtest = train_test_split(test,test_size=0.40,random_state=42)
